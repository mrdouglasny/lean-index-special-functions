...
<!-- STATS_START -->
**13,590 topic-matched declarations** across **19 repositories** (scanned 31 repos, 21,843 declarations).

Tracks Lean declarations related to:
- **Power series** (3,151 matches): formal/multivariate power series, Hahn series, Fourier/Mellin transforms
- **Exponential and logarithmic** (2,889 matches): exp, log, rpow, sqrt, complex powers
- **Trigonometric** (2,353 matches): sin, cos, tan, arctan, hyperbolic functions, Chebyshev polynomials
- **Zeta and L-functions** (1,896 matches): Riemann/Hurwitz zeta, Dirichlet L-series, Euler products, Bernoulli numbers, arithmetic functions
- **Elliptic curves** (1,478 matches): Weierstrass curves, division polynomials, j-invariant
- **Modular forms** (1,444 matches): modular/cusp forms, Eisenstein series, Jacobi theta, Dedekind eta, upper half plane
- **Classical special functions** (1,114 matches): Gamma, Beta, digamma, Pochhammer, hypergeometric, Gaussian, Stirling, Hermite, elliptic functions
<!-- STATS_END -->
...
|-----------|:---:|-------------|
| [leanprover-community/mathlib4](https://github.com/leanprover-community/mathlib4) | 12,295 | The math library for Lean 4 (indexed via cache, not cloned) |
| [AlexKontorovich/PrimeNumberTheoremAnd](https://github.com/AlexKontorovich/PrimeNumberTheoremAnd) | 518 | Prime Number Theorem, L-series, Mellin transforms |
