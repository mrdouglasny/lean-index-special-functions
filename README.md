...
<!-- STATS_START -->
**13,113 topic-matched declarations** across **18 repositories** (scanned 28 repos, 20,981 declarations).

Tracks Lean declarations related to:
- **Power series** (3,052 matches): formal/multivariate power series, Hahn series, Fourier/Mellin transforms
- **Exponential and logarithmic** (2,810 matches): exp, log, rpow, sqrt, complex powers
- **Trigonometric** (2,276 matches): sin, cos, tan, arctan, hyperbolic functions, Chebyshev polynomials
- **Zeta and L-functions** (1,802 matches): Riemann/Hurwitz zeta, Dirichlet L-series, Euler products, Bernoulli numbers, arithmetic functions
- **Elliptic curves** (1,417 matches): Weierstrass curves, division polynomials, j-invariant
- **Modular forms** (1,348 matches): modular/cusp forms, Eisenstein series, Jacobi theta, Dedekind eta, upper half plane
...
|-----------|:---:|-------------|
| [leanprover-community/mathlib4](https://github.com/leanprover-community/mathlib4) | 11,946 | The math library for Lean 4 (indexed via cache, not cloned) |
