...
<!-- STATS_START -->
**13,429 topic-matched declarations** across **19 repositories** (scanned 31 repos, 21,610 declarations).

Tracks Lean declarations related to:
- **Power series** (3,130 matches): formal/multivariate power series, Hahn series, Fourier/Mellin transforms
- **Exponential and logarithmic** (2,872 matches): exp, log, rpow, sqrt, complex powers
- **Trigonometric** (2,306 matches): sin, cos, tan, arctan, hyperbolic functions, Chebyshev polynomials
- **Zeta and L-functions** (1,890 matches): Riemann/Hurwitz zeta, Dirichlet L-series, Euler products, Bernoulli numbers, arithmetic functions
- **Elliptic curves** (1,435 matches): Weierstrass curves, division polynomials, j-invariant
- **Modular forms** (1,407 matches): modular/cusp forms, Eisenstein series, Jacobi theta, Dedekind eta, upper half plane
- **Classical special functions** (1,120 matches): Gamma, Beta, digamma, Pochhammer, hypergeometric, Gaussian, Stirling, Hermite, elliptic functions
<!-- STATS_END -->
...
|-----------|:---:|-------------|
| [leanprover-community/mathlib4](https://github.com/leanprover-community/mathlib4) | 12,183 | The math library for Lean 4 (indexed via cache, not cloned) |
| [AlexKontorovich/PrimeNumberTheoremAnd](https://github.com/AlexKontorovich/PrimeNumberTheoremAnd) | 469 | Prime Number Theorem, L-series, Mellin transforms |
