...
<!-- STATS_START -->
**12,643 topic-matched declarations** across **18 repositories** (scanned 28 repos, 19,617 declarations).

Tracks Lean declarations related to:
- **Power series** (2,945 matches): formal/multivariate power series, Hahn series, Fourier/Mellin transforms
- **Exponential and logarithmic** (2,771 matches): exp, log, rpow, sqrt, complex powers
- **Trigonometric** (2,247 matches): sin, cos, tan, arctan, hyperbolic functions, Chebyshev polynomials
- **Zeta and L-functions** (1,618 matches): Riemann/Hurwitz zeta, Dirichlet L-series, Euler products, Bernoulli numbers, arithmetic functions
- **Elliptic curves** (1,361 matches): Weierstrass curves, division polynomials, j-invariant
...
|-----------|:---:|-------------|
| [leanprover-community/mathlib4](https://github.com/leanprover-community/mathlib4) | 11,655 | The math library for Lean 4 (indexed via cache, not cloned) |
| [AlexKontorovich/PrimeNumberTheoremAnd](https://github.com/AlexKontorovich/PrimeNumberTheoremAnd) | 380 | Prime Number Theorem, L-series, Mellin transforms |
...
| [attila-ac/hyperlocal](https://github.com/attila-ac/hyperlocal) | 15 | Off-Critical Riemann Zeta Zeros Cannot Seed Symmetric Entire Functions: A... |
